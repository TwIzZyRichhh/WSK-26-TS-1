...
function promptForBook() {
    ...
    const bookAuthor = prompt("Enter input for author") ?? ""/* TODO: Get user input for author */;
    const bookPublicationYear = Number(prompt("Enter publication year")) /* TODO: Get user input for publication year */;
